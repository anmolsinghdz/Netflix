...
public class VideoController {
    ...
    public ResponseEntity<String> uploadVideo(@PathVariable String movieId,
                                              @RequestParam("file") MultipartFile file)throws IOException {
        log.info("Video upload request for movie: {} filesize: {}MB ", movieId, file.getSize()/(1024*1024));
        ...
        return ResponseEntity.ok("Video uploaded successfully, VideoKey: "+videoKey+
